...
import BeamRain from '@/components/backgrounds/BeamRain'
  ...
  return (
    <>
      <MeshBackground
        ...
        background='#020617'
        points={[
          { color: '#030712', x: 10, y: 20, spread: 20, opacity: 0.9 },
          { color: '#03042c', x: 85, y: 15, spread: 20, opacity: 0.5 },
          { color: '#0a1051', x: 25, y: 80, spread: 20, opacity: 0.4 },
          { color: '#172090', x: 75, y: 75, spread: 20, opacity: 0.4 },
      ...
      <BeamRain
        beams={[
          { color: '#00fbea', width: 2, x: 10, opacity: 0.1, decoration: 'none' },
          { color: '#00fbea', width: 2, x: 20, opacity: 0.1, decoration: 'none' },
          { color: '#00fbea', width: 2, x: 30, opacity: 0.2, decoration: 'dot' },
          { color: '#00fbea', width: 2, x: 40, opacity: 0.1, decoration: 'none' },
          { color: '#00fbea', width: 2, x: 50, opacity: 0.4, decoration: 'chevron' },
          { color: '#00fbea', width: 2, x: 60, opacity: 0.1, decoration: 'none' },
          { color: '#00fbea', width: 2, x: 70, opacity: 0.2, decoration: 'dot' },
          { color: '#00fbea', width: 2, x: 80, opacity: 0.1, decoration: 'none' },
          { color: '#00fbea', width: 2, x: 90, opacity: 0.1, decoration: 'none' },
        ]}
      />
