...
const tech = (key: string, name: string, icon: string, color?: string): TechDetailType => ({ key, name, icon, color })
...
export const techList: Record<string, TechDetailType> = {
  ...
  motion: tech('motion', 'Motion', 'devicon:motion', '#fff312'),
  canvas: tech('canvas', 'Canvas API', 'arcticons:mi-canvas', '#38bdf8'),
  ...
  nextjs: tech('nextjs', 'Next.js', 'devicon:nextjs', '#f8fafc'),
  ...
  reactHookForm: tech('reactHookForm', 'React Hook Form', 'simple-icons:reacthookform', '#ec5990'),
